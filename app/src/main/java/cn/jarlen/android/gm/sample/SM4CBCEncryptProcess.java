 ...
 * SM3执行处理类
 */
public class SM4CBCEncryptProcess extends CryptoProcess {

    public SM4CBCEncryptProcess(ProcessCallBack callBack) {
        super(callBack);
    }
    ...
    void onProcess(Context context, String data, List<String> params) {
        ...
        byte[] encrypt = SM4.encrypt(data.getBytes(StandardCharsets.UTF_8), key, iv);
